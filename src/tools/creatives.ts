      ...
      try {
        ...
        const response = {
          ...
          creative_details: {
            ...
            title: creativeDetails.title || creativeDetails.object_story_spec?.link_data?.name || creativeDetails.object_story_spec?.video_data?.title || "",
            body: creativeDetails.body || creativeDetails.object_story_spec?.link_data?.message || creativeDetails.object_story_spec?.video_data?.message || creativeDetails.object_story_spec?.template_data?.message || "",
            image_url: creativeDetails.image_url || creativeDetails.thumbnail_url || creativeDetails.object_story_spec?.link_data?.picture || creativeDetails.object_story_spec?.link_data?.image_url || creativeDetails.object_story_spec?.video_data?.image_url || "",
            video_id: creativeDetails.video_id || creativeDetails.object_story_spec?.video_data?.video_id || "",
            link_url: creativeDetails.object_story_spec?.link_data?.link || creativeDetails.object_story_spec?.template_data?.link || "",
            call_to_action: creativeDetails.call_to_action?.type || creativeDetails.object_story_spec?.link_data?.call_to_action?.type || creativeDetails.object_story_spec?.video_data?.call_to_action?.type || "",
